...
import { FiPackage, FiX, FiBox } from 'react-icons/fi';
import itemPresentacionService from '../../services/itemPresentacionService';

const ItemSelectorPlantilla = ({ 
    item, 
    onUpdate, 
    onRemove, 
    index
    ...
    const [cantidadPresentacion, setCantidadPresentacion] = useState(item.Cantidad_Presentacion || '');
    const [esPorPresentacion, setEsPorPresentacion] = useState(item.Es_Por_Presentacion || false);
    ...
    }, [cantidad, presentacionSeleccionada, cantidadPresentacion, esPorPresentacion]);
    ...
    const updateOnCantidadChange = () => {
        ...
        if (esPorPresentacion && presentacionSeleccionada) {
            ...
            onUpdate(item.Item_Id, cantidadBase, { Es_Por_Presentacion: false });
        }
    };
            ...
            return (
                <div className="text-sm">
                    <div className="font-medium text-purple-600">
                        {formatearNumero(cantPresNum)} {presentacionSeleccionada?.Presentacion_Nombre || 'pres'}
                    </div>
    ...
    return (
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-purple-300 transition-colors">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                <h3 className="font-medium text-gray-800 text-sm">
                                    {item.Item_Codigo_SKU || item.Item_Codigo}
                                </h3>
                        ...
                        >
                            ...
                            {presentacionesDisponibles.map(presentacion => (
                                <option key={presentacion.Item_Presentaciones_Id} value={presentacion.Item_Presentaciones_Id}>
                                    {presentacion.Presentacion_Nombre} ({presentacion.Presentacion_Unidad_Prefijo || presentacion.UnidadMedida_Prefijo})
                    ...
                    {esPorPresentacion ? (
                        <div className="space-y-2">
                            <input
                                ...
                                min="0"
                                step="0.01"
                                placeholder={`Cantidad en ${presentacionSeleccionada?.Presentacion_Nombre || 'presentación'}`}
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg
            ...
            <div className="hidden lg:grid lg:grid-cols-12 lg:gap-4 lg:items-start">
                {/* Producto */}
                <div className="col-span-5 flex items-start gap-3 pt-2">
                    <div className="flex-shrink-0">
                    ...
                    {presentacionesDisponibles.length > 0 && (
                        <select
                            ...
                            className="w-full px-2 py-1 border border-gray-200 rounded mb-2
                                     ...
                                     focus:outline-none focus:ring-1 focus:ring-purple-500/20 focus:border-purple-500"
                        >
...
export default ItemSelectorPlantilla;
